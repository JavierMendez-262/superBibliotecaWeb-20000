<%-- 
    Document   : capturaRevista
    Created on : 24/11/2019, 09:01:39 PM
            ...
            <form action="agregaRevista" method="post" name="capturaCancion" >
                <div class="tabla">
                    <div class="fila">
                        ...
                        <div class="celda">
                            <input type="text" id="isbnId" name="isbn" value="${param.isbn}" size="13" readonly>
                        </div>
                        <div class="celda">&nbsp;</div>
                    </div>
                    <div class="fila">
                        ...
                        <div class="celda">
                            <input type="text" id="tituloId" name="titulo" value="${param.titulo}" size="35" maxlength="35" required placeholder="T&iacute;tulo de la Revista">
                        </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="celda">
                            <input type="text" id="editorialId" name="editorial" value="${param.editorial}" size="35" maxlength="35" required placeholder="Editorial de la Revista">
                        </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="celda">
                            <input type="text" id="clasificacionId" name="clasificacion" value="${param.clasificacion}" size="20" maxlength="20" required placeholder="Clasificaci&oacute;n de la Revista">
                        </div>
                    ...
                    <div class="fila">
                        ...
                        <div class="celda">
                            <input type="text" id="periodicidadId" name="periodicidad" value="${param.periodicidad}" size="35" maxlength="35" placeholder="Periodicidad de la Revista">
                        </div>
